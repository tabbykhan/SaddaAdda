...
public class BuyTransAdapter extends RecyclerView.Adapter<BuyTransAdapter.BuyHolder> {
    ...
    public BuyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_buy_trans, parent, false);
    ...
    public void update(ArrayList<TransRecord> reportData, int pos) {
        reportDataArrayList = reportData;
    ...
    public class BuyHolder extends RecyclerView.ViewHolder {
        ...
        void expend() {
            if (activity instanceof BuyTransReportActivity)
                ((BuyTransReportActivity) activity).checkOpen(getAdapterPosition());
            else
                ((WithDrawTransReportActivity) activity).checkOpen(getAdapterPosition());
